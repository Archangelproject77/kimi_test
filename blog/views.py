...
def logoutUser(request):
    logout(request)
    messages.info(request, "Logged out of ArchBLOG")
...
def postdetail(request, slug):
    ...
    return render(request, 'blog/detail.html', {'post': post, 'post_in_favorites': post_in_favorites,
...
def favorites(request):
    ...
    return render(request, 'blog/favourites.html', { 'post_list': FavPosts.posts.all(), "favorites": True})
...
def posts_by_tag(request, slug):
    ...
    return render(request, 'blog/postsbytag.html', { 'posts': posts })
